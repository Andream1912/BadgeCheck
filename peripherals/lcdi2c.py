...
class I2cLcd(LcdApi):
    def __init__(self, i2c, num_lines, num_columns):
        self.i2c = i2c
        self.i2cWrite(0)
        self.lastdata = 0x00
        sleep(20)
    ...
    def hal_write_init_nibble(self, nibble):
        ...
        self.i2cWrite(byte | MASK_E)
        self.i2cWrite(byte)

    def hal_backlight_on(self):
        """Allows the hal layer to turn the backlight on."""
        self.i2cWrite(1 << SHIFT_BACKLIGHT)
